...
impl<B: BusOperation, LPN: OutputPin, T: DelayNs> Vl53l7cx<B, LPN, T> {
     ...
     * @return ([DetectionThresholds; VL53L7CX_NB_THRESHOLDS]) thresholds : Array of 64 thresholds.
     */
    #[allow(dead_code)]
     ...
     * @param (&mut [DetectionThresholds; VL53L7CX_NB_THRESHOLDS]) thresholds :  Array of 64 thresholds.
     */
    #[allow(dead_code)]
