...
pub struct Vl53l7cx<B: BusOperation, LPN: OutputPin, T: DelayNs> {
    pub temp_buffer: [u8;  VL53L7CX_TEMPORARY_BUFFER_SIZE],
    pub offset_data: [u8;  VL53L7CX_OFFSET_BUFFER_SIZE],
    pub xtalk_data: [u8; VL53L7CX_XTALK_BUFFER_SIZE],
    pub streamcount: u8,
 ...
 */
    ...
    /**
     * @brief Check if the VL53L7CX sensor is alive(responding to I2C communication).
    */
